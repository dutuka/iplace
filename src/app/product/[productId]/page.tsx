    ...
    return <MaxWidthWrapper className="bg-white">
        <div className="bg-white">
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                        ...
                        {BREADCRUMBS.map((breadcrumbs, i) =>(
                            <li key={breadcrumbs.href}>
                                <div className="flex item-center text-sm">
                                    <Link href={breadcrumbs.href} className="font-medium text-sm text-muted-foreground hover:text-grey-900">
                                        {breadcrumbs.name} 
                                        </Link>
                ...
                { /* Product images*/ }
                <div className='mt-10 lg:col-start-2 lg:row-start-2 lt:mt-0 lg:self-center'>
